...
RSpec.describe TicketsController, type: :controller do
  ...
  # adjust the attributes here as welld.
  let(:valid_attributes) { {:raffle_id => 1, :email => Faker::Internet.email} }
